...
class SaveTheDateDatabaseNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase(object $notifiable): array
    {
        ...
        $message = match ($this->key) {
            ...
            default => [
                'title' => 'Save the Date Notification',
                'body' => 'New activity in Save the Date.',
            ],
        };
        ...
        return [
            ...
            'entity' => [
                'type' => NotificationEntities::SAVE_THE_DATE,
                'id' => $this->entityId,
            ],
            'message' => $message,
